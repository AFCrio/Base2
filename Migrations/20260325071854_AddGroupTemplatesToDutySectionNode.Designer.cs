...
namespace Base2.Migrations
{
    ...
    [Migration("20260325071854_AddGroupTemplatesToDutySectionNode")]
    partial class AddGroupTemplatesToDutySectionNode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Base2.Models.AppSetting", b =>
                {
            ...
            modelBuilder.Entity("Base2.Models.DutyAssignment", b =>
                {
                    ...
                    b.Property<string>("RenderedLine")
                        .IsRequired()
                        .HasMaxLength(2000)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Base2.Models.DutySectionNode", b =>
                {
                    ...
                    b.Property<string>("GroupHeaderTemplate")
                        .HasMaxLength(500)
                        .HasColumnType("TEXT");

                    b.Property<string>("GroupItemTemplate")
                        .HasMaxLength(500)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Base2.Models.WeaponAmmoPreset", b =>
                {
                    b.Property<int>("WeaponAmmoPresetId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasKey("WeaponAmmoPresetId");

                    b.HasIndex("WeaponType")
                        .IsUnique();

                    b.ToTable("WeaponAmmoPresets");
            ...
            modelBuilder.Entity("Base2.Models.DutySectionNode", b =>
                {
                    ...
                    b.HasOne("Base2.Models.Location", "Location")
                        .WithMany("SectionNodes")
            ...
            modelBuilder.Entity("Base2.Models.Weapon", b =>
                {
                    b.HasOne("Base2.Models.Person", "AssignedToPerson")
                        .WithMany("AssignedWeapons")
